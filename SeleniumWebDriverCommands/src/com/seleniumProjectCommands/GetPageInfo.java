...
public class GetPageInfo {
	 ...
	 public static void main(String[] args) {
	        ...
	        System.out.println("Source 1 Length: " + source1.length());
	        System.out.println("Source 2 Length: " + source2.length());
	        System.out.println("Source 3 Length: " + source3.length());
	        System.out.println("Source 4 Length: " + source4.length());
	        System.out.println("Source 5 Length: " + source5.length());
